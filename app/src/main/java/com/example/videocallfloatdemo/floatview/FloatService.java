package com.example.videocallfloatdemo.floatview;
...
import com.example.videocallfloatdemo.R;
...
public class FloatService extends Service {
    ...
    private void initWindow() {
        ...
        // 获取浮动窗口视图所在布局
        mFloatingLayout = inflater.inflate(R.layout.small, null);
        // 添加悬浮窗的视图
    ...
    private void initFloating() {
        smallSizePreviewLayout = mFloatingLayout.findViewById(R.id.tv_main);
